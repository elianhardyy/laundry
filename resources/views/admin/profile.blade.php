...
<div class="row">
  <div class="col-lg-4 col-xlg-3 col-md-5">
    <div class="card">
      ...
      <form action="/img-profile-post" method="post" enctype="multipart/form-data">
        @csrf
      ...
      <div class="card-body"> <small class="text-muted">Email address </small>
        ...
        <div class="d-flex justify-content-between">
          <a data-toggle="modal" data-target="#edit_profile" id="click_profile_edit" class="btn btn-primary mt-2" data-id="{{$profile->id}}" data-email="{{$profile->email}}" data-name="{{$profile->username}}">Edit Profile</a>
