...
<div class="row">
  ...
  <div class="col-lg-3 col-sm-6 col-12">
    <div class="card">
      <div class="card-header d-flex align-items-start pb-0">
        <div>
          <h2 class="text-bold-700 mb-0">AMbil</h2>
          <p>Laundry Diambil</p>
        </div>
        ...
        <div class="row">
          <div class="col-xl-4 col-sm-6 col-12 mb-2 mb-xl-0">
            <div class="media">
              ...
              <div class="media-body my-auto">
                <h5 class="font-weight-bolder mb-0">Rp 1000</h5>
          ...
          <div class="col-xl-4 col-sm-6 col-12 mb-2 mb-xl-0">
            <div class="media">
              ...
              <div class="media-body my-auto">
                <h5 class="font-weight-bolder mb-0"> Rp 9000 </h5>
          ...
          <div class="col-xl-4 col-sm-6 col-12 mb-2 mb-sm-0">
            <div class="media">
              ...
              <div class="media-body my-auto">
                <h5 class="font-weight-bolder mb-0">Rp 80000</h5>
        ...
        <div class="row">
          <div class="col-xl-6 col-sm-6 col-12 mb-2 mb-xl-0">
            <div class="media">
              ...
              <div class="media-body my-auto">
                <h4 class="font-weight-bolder mb-0">Rp 70000</h4>
          ...
          <div class="col-xl-6 col-sm-6 col-12 mb-2 mb-xl-0">
            <div class="media">
              ...
              <div class="media-body my-auto">
                <h4 class="font-weight-bolder mb-0">Rp 4000</h4>
