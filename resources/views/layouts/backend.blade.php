      ...
      <div class="navbar-container content">
        <div class="navbar-collapse" id="navbar-mobile">
          ...
          <ul class="nav navbar-nav float-right">
            <li class="dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ficon feather icon-bell"></i><span class="badge badge-pill badge-primary badge-up">getNotifikasi</span></a>
              <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                ...
                <li class="scrollable-container media-list">
                  <!-- forelse --> getNotifikasi id
                  <a data-id-notif="notifikasi_id" id="readNotif">
                    <div class="media d-flex align-items-start">
                      <div class="media-body">
                        <p class="media-heading"><span class="font-weight-bolder">notifikasis->title 🎉</span></p><small class="notification-text">notifikasi body.</small>
                      </div>
                    </div>
                  </a>
                  <!-- empty -->
            ...
            <li class="dropdown dropdown-user nav-item">
              <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                ...
                <span>
                  ...
                  <img class="round" src="{{asset('storage/'.auth()->user()->profile->foto)}}" alt="avatar" height="40" width="40">
                  @else
                  <img class="round" src="{{asset('img/hero/hero2.png')}}" alt="avatar" height="40" width="40">
                  @endif
                </span>
              </a>
              <div class="dropdown-menu dropdown-menu-right">
                @if (auth::user()->auth == 'admin')
                <a class="dropdown-item" href="{{url('admin-profile', auth::user()->id )}}"><i class="feather icon-user"></i>Profile
                </a>
                @elseif(auth::user()->auth == 'pelanggan')
                <a class="dropdown-item" href="{{url('user-profile', auth::user()->id )}}"><i class="feather icon-user"></i>Profile
                </a>
                @endif
  ...
  <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        <li class="nav-item {{ (request()->is('admin')) ? 'active' : '' }}"><a href="/admin"><i class="feather icon-home"></i><span class="menu-title" data-i18n="Dashboard">Dashboard</span></a>
        </li>
        ...
        <li class=" nav-item"><a href="#"><i class="feather icon-users"></i><span class="menu-title" data-i18n="User">Data User</span></a>
          <ul class="menu-content">
            <li class="nav-item {{ (request()->is('karyawan')) ? 'active' : '' }}">
              <a href="/#"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">Karyawan</span></a>
            </li>
            <li class="nav-item {{ (request()->is('customer')) ? 'active' : '' }}">
              <a href="/customer"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="List">Customer</span></a>
            </li>
          </ul>
        </li>

        <li class="nav-item {{ (request()->is('daftar-harga')) ? 'active' : '' }} ">
          <a href="/daftar-harga"><i class="feather icon-shopping-cart"></i><span class="menu-item" data-i18n="List">Jenis Laundry</span></a>
        </li>
